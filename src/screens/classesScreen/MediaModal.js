...
const MediaModal = props => {
    ...
    const { isVisible, setIsVisible, availableMedia,media, setMedia } = props;
    ...
    return (
            ...
            >
                ...
                <ScrollView>
                        <AvailableMediaList media={media} setMedia={setMedia} availableMedia={availableMedia} isVisible={isVisible} setIsVisible={setIsVisible}/>
                </ScrollView>
                </View>
            </Modal>
    );
